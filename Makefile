...
DEFINES =		-DFASTSERVER
FONTLIBDIR = 		$(LIBDIR)/xfig
CDEBUGFLAGS =		-O

XFIGSRC =	d_arc.c d_arcbox.c d_box.c d_ellipse.c d_epsbitmap.c\
		...
		f_load.c f_read.c f_epsbitmap.c\
		...
		w_canvas.c w_cmdpanel.c w_cursor.c w_drawprim.c w_export.c\
...
XFIGOBJ =	d_arc.o d_arcbox.o d_box.o d_ellipse.o d_epsbitmap.o\
		...
		f_load.o f_read.o f_epsbitmap.o\
		...
		w_canvas.o w_cmdpanel.o w_cursor.o w_drawprim.o w_export.o\
...
install.man:: xfig.man
	$(INSTALL) -c $(INSTMANFLAGS) xfig.man $(MANDIR)/xfig.l
